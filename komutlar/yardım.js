...
exports.run = (client, message, params) => {
  ...
  .addField("**Ana Komutlar**", "?yardım = BOT Komutlarını Gösterir.\n \?bilgi = BOT Kendisi Hakkında Bilgi Verir.\n \?ping = BOT Gecikme Süresini Söyler.\n \?davet = BOT Davet Linkini Atar.\n \?istatistik = BOT İstatistiklerini Atar.")
  .addField("**Müzik Komutları**","?çal = İştediğiniz Şarkıyı Çalar.\n \?geç = Sıradaki şarkıya geçer sırada şarkı yoksa kanaldan çıkar.\n \?ses = Müziğin sesini artırır.\n \?çalan = Çalan Şarıyı Gösterir.\n \?duraklat = Müziği Duraklatır.")
  .addField("**Yapımcı**", " **Oğuzhan Dağlı** ")
  .setFooter("**Bot Sürümü 1.5.2.1'dır** ")
  if (!params[0]) {
